...
document.write(mas5 + " " + "//splice(0,1,0)" + "<br/>" + spliceDeleteAdd + "<br/>");
var spliceDelete = mas5.splice(0,2);
document.write(mas5 +  " " + "//splice(0,2)" + "<br/>" + spliceDelete + "<br/>" + "<br/>");

//slice
var mas6= [2,5,4,7,8,9,14];
document.write(mas6 + "<br/>")
var slice = mas6.slice(0,1);
document.write(mas6 + " " + "//slice(0,1)" + "<br/>" + slice + "<br/>" + "<br/>");
...
mas12.forEach((item, index, mas) => document.write(`id: ${item.id} name: ${item.name} <br/>`) )
...
mas13.forEach((item, index, mas) => document.write(`id: ${item.id} name: ${item.name} <br/>`) )
var filter = mas12.filter(item => item.id > 1);
filter.forEach(item => document.write(`id: ${item.id}  name: ${item.name}  //filter(id > 1)  <br/>`));
...
mas14.forEach((item, index, mas) => document.write(`id: ${item.id} name: ${item.name} <br/>`) )
...
mas15.forEach((item, index, mas) => document.write(`id: ${item.id} name: ${item.name} <br/>`) )
...
mas16.forEach((item, index, mas) => document.write(`id: ${item.id} name: ${item.name} <br/>`) )
var map = mas16.map(item => ({
  id: item.id + 1,
  name: item.name,
}));
map.forEach(item => document.write(`id: ${item.id}  name: ${item.name}  //map(id + 1)  <br/>`));
...
document.write(reduse + " " + "//reduse() " + "<br/>");

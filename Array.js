...
mas22.forEach((item, index, mas) =>
  document.write(` id: ${item.id} name: ${item.name} <br/>`)
);
document.write("<br/>");

var newMas22 = mas22.olehMap(function(item) {
  return item;
});

newMas22.forEach(item =>
  document.write(`id: ${item.id}  name: ${item.name}  //olehMap  <br/>`)
);
document.write("<br/>");
...
var mas21 = [2, 5, 4, 7, 8, 9, 14];
document.write(mas21 + " " + "//olehForEach(item*2)" + "<br/>");

mas21.olehForEach(function(item, index) {
  document.write("index:" + index + " " + "value:" + item * 2 + "<br/>");
});
document.write("<br/>");
...
var mas22 = [1, 2, 3, 4];
document.write(`${mas22} <br/>`);

var newMas22 = mas22.olehFilter(function(n) {
  return n >= 2;
});
document.write(newMas22 + "//olehFilter(n>=2)" + "<br/>" + "<br/>");
...
var mas23 = [12, 5, 8, 130, 44];
document.write(mas23 + "<br/>");
var newMas23 = mas23.olehEvery(function(element) {
  return element >= 10;
});
document.write(newMas23 + " " + "//olehEvery(element >= 10)" + "<br/>");

var mas24 = [12, 54, 18, 130, 44]
document.write(mas24 + "<br/>");

var newMas24 = mas24.olehEvery(function(element) {
  return element >= 10;
});
document.write(newMas24 + " " + "//olehEvery(element >= 10)" + "<br/>" + "<br/>"); 
...
var mas25 = [12, 5, 8, 130, 44]
document.write(mas25 + "<br/>");

var newMas25 = mas25.olehSome(function(element) {
  return element >= 200;
});
document.write("olehSome(element >= 200): " + newMas25 + "<br/>"); 

var mas26 = [12, 15, 38, 13, 144]
document.write(mas26 + "<br/>");

var newMas26 = mas26.olehSome(function(element) {
  return element >= 100;
});
document.write("olehSome(element >= 100): " + newMas26);
